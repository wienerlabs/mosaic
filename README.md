...
[![Release: v0.9.6-halo2-multi-lookup](https://img.shields.io/badge/release-v0.9.6--halo2--multi--lookup-green.svg)](https://github.com/wienerlabs/mosaic/releases/tag/v0.9.6-halo2-multi-lookup)
